package com.indicosmic.www.mypolicynow.break_in_manager.receiver;
...
import com.indicosmic.www.mypolicynow.OtpActivity;
import com.indicosmic.www.mypolicynow.utils.SingletonClass;


/**
 * Created by Ind3 on 01-02-18.
 */
...
public class SmsReceiver extends BroadcastReceiver {
    ...
    public static final String SMS_ORIGIN = "BRKINSMS";
        ...
        try {
            if (bundle != null) {
                ...
                for (Object aPdusObj : pdusObj) {
                    ...
                    OtpActivity otp = new OtpActivity();
                    //otp.putOtp(verificationCode);
                   ...
                   /* Intent hhtpIntent = new Intent(context, HttpService.class);
                    ...
                    if(SingletonClass.getinstance().strOtp.equals(verificationCode))
                    {
