...
public class InprogressInspectionDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inprogress_inspection_details);
    ...
    private void init() {
        ...
        til_text.setText("Inprogress Inspection Details");
        ...
        btnCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(InprogressInspectionDetails.this).create();
                ...
                alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Call", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (ActivityCompat.checkSelfPermission(InprogressInspectionDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//        });
        ...
        showInprogressInspectionDetails();
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(getApplicationContext(), InprogressInspection.class);
        startActivity(intent);
        overridePendingTransition(R.animator.left_right,R.animator.right_left);
        finish();
    }

    private void showInprogressInspectionDetails() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (status.trim().contains("True")) {
                        ...
                        String str_register_date = customer_inspect_obj.getString("manf_date");
                        ...
                        registration_date.setText(str_register_date);
