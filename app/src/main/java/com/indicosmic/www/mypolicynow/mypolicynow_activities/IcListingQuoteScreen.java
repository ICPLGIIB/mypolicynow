...
public class IcListingQuoteScreen extends AppCompatActivity {
    ...
    private void ShowPopup_Accessories() {
        ...
        DialogAccessiores = new Dialog(IcListingQuoteScreen.this);
    ...
    private void ShowPopup_Deductibles() {
        ...
        DialogDeductibles = new Dialog(IcListingQuoteScreen.this);
        ...
        EdtAA_ExpiryDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AA_ExpiryDatePickerDialog = new DatePickerDialog(IcListingQuoteScreen.this,
    ...
    private void ShowPopup_GeographicalExtension() {
        ...
        DialogGeographicalExtension = new Dialog(IcListingQuoteScreen.this);
    ...
    private void ShowPopup_PACovers() {
        ...
        DialogPACovers = new Dialog(IcListingQuoteScreen.this);
