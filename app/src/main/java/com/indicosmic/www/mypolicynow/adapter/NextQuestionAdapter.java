...
import com.indicosmic.www.mypolicynow.break_in_manager.NextQuestions;
...
public class NextQuestionAdapter extends BaseAdapter{


    private List<NextQuestionModel> dataList;
    Context mCtc;
    ...
    public NextQuestionAdapter(List<NextQuestionModel> getData, Context context) {
        dataList = getData;
        mCtc = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final NextQuestionModel dataSet = (NextQuestionModel) dataList.get(position);
        ...
        viewHolder.camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((NextQuestions) mCtc).captureImage(dataSet.getListItemPosition(), dataSet.getId() + "" + dataSet.getQuestion());
                viewHolder.image.setImageBitmap(dataSet.getImage());
    ...
    public void setImageInItem(final int position, Bitmap imageSrc, final String imagePath) {
        ...
        if(SingletonClass.getinstance().agent_id==null){
            SingletonClass.getinstance().agent_id =  SharedPrefManager.getInstance(mCtc).getAgent().id;
        }


        NextQuestionModel dataSet = (NextQuestionModel) dataList.get(position);
        ...
        try {
            ...
            jsonObject.put("break_in_case_id", SingletonClass.getinstance().break_in_case_id);
