...
public class NextQuestionModel {
    ...
    public NextQuestionModel() {
    }

    public NextQuestionModel(String id, String question, String camera, Bitmap image, int listItemPosition, String imagePath, boolean haveImage, boolean status) {
        this.id = id;
