...
public class QuotationActivity_2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void init() {
        ...
        til_text.setText("GET QUICK QUOTE");

        myDialog = new ProgressDialog(QuotationActivity_2.this);
       ...
       /* ArrayAdapter<String> monthAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.spinner_item, Constant.Month);
        ...
        EdtPreviousPolicyExpiryDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prePolicyExpiryDatePickerDialog = new DatePickerDialog(QuotationActivity_2.this,
        ...
        if(QuotationFor!=null && !QuotationFor.equalsIgnoreCase("")){
            if(QuotationFor.equalsIgnoreCase("Car")){
                ...
                Glide.with(QuotationActivity_2.this).load(R.drawable.bike).into(iv_bike);
                Glide.with(QuotationActivity_2.this).load(R.drawable.car).into(iv_car);
                Glide.with(QuotationActivity_2.this).load(R.drawable.commercial_new).into(iv_commercial);
...
*/
    ...
    private void setRegistrationDate(int Year, int Month, int Day) {
        ...
        registrationDatePickerDialog = new DatePickerDialog(QuotationActivity_2.this,
                android.R.style.Theme_Holo_Light_Dialog,new DatePickerDialog.OnDateSetListener() {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(getApplicationContext(),IcListingQuoteScreen_3.class);
                        startActivity(intent);
