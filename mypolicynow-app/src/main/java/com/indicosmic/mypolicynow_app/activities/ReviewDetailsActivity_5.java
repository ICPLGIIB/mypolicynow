...
import static com.indicosmic.mypolicynow_app.webservices.RestClient.ROOT_IC_IMAGE_URL;
...
public class ReviewDetailsActivity_5 extends AppCompatActivity {
    ...
    Dialog DialogUploadPolicy,DialogBreakInCase;
    Uri fileUri;
    ...
    private void setDataToView() {
        ...
        try{
            ...
            StrImageUrl = ROOT_IC_IMAGE_URL+ic_logo;
            ...
            UtilitySharedPreferences.setPrefs(getApplicationContext(),"IC_NAME",ic_name);
    ...
    private void showBreakInPopUp(boolean show_skip_btn) {
        ...
        btnViewProposal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UtilitySharedPreferences.setPrefs(getApplicationContext(),"IsBreakInInspectionDone","false");
